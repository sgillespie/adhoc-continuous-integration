...
create a container that automates running the stages.
...
**Build Definition**: We need a way to configure several build jobs. We
...
difficult to maintain, so we would suggest dropping this requirement
